...
def _postgres_sql(sql):
    ...
    # IMPORTANTE: Access também aceita SELECT DISTINCT TOP n.
    # A versão anterior só reconhecia SELECT TOP n e deixava TOP no SQL,
    # causando "syntax error at end of input" em algumas consultas.
    m = re.search(
